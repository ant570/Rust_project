    ...
    fn build(&self, app: &mut App) {
        ...
        .add_systems(
            ...
            settings::settings_action
                .run_if(in_state(GameState::SettingsStart).or(in_state(GameState::SettingsPause))),
        );
    }
}
